/* SVG icon primitives — zero external deps */
...
export const RobotIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 11V5" /><circle cx="12" cy="3" r="2" />
...
export const FlaskIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    <path d="M10 2v7.31L4.62 19.1A2 2 0 0 0 6.34 22h11.32a2 2 0 0 0 1.72-2.9L14 9.31V2" />
